...
Route::get('/selectcust-erp', 'HomeController@selectcust_erp')->name('selectcust_erp');
...
Route::post('/custaktivitas-erp', 'CustomerERPController@search_cust_aktivitas')->name('search_cust_aktivitas_erp');
Route::post('/tabelcustaktivitas', 'CustomerController@tabel_show_aktivitas')->name('tabel_show_aktivitas'); //json calender
Route::post('/tabelcustaktivitas-erp', 'CustomerERPController@tabel_show_aktivitas')->name('tabel_show_aktivitas_erp');
