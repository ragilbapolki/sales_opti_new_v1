...
@section('minititle', 'ERP Stok Barang')
                        ...
                        <div class="col-xs-12" id="hasil">
                            <div class="box box-hijau">
                                <div class="box-header with-border bg-warning">
                                    ...
                                    <h4 class="box-title">Stok Barang {{ $tgl }} {{ $kodecabang }} <small>Harga
                                            Sudah
                                            Termasuk PPN.</small></h4>
                                </div>
                                <div class="box-body table-bordered no-padding">
                                    <div class="col-xs-12">
                                        <!-- <table id="custrank" class="display nowrap compact" cellspacing="0" width="100%"> -->
                                        <table id="itemstok" class="display cell-border compact" cellspacing="0"
                                            width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Code/SKU</th>
