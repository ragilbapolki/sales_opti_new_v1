            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <label>Nama Sales</label> --}}
                                        <input type="hidden" name="sales" class="form-control" value="-" readonly />
                                        {{-- </div> --}}
                                        {{-- <div class="form-group"> 
                    ...
                    <span style="color:red">* Silahkan generate invoice untuk melanjutkan transaksi !</span>                             
                        ...
                        <option value="">- Pilih Nama -</option>
                                            ...
                                            <input type="text" class="form-control" name="namacustmember"
                                                id="namacustmember" value="{{ Auth::user()->username }}" readonly />
                                        </div>
                                        <div class="form-group" style="display: none">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" checked name="chbtipecus" id="chkcus"
                                                        value="1" />
                                                    Customer Baru
                                                </label><br>
                                                <span id="notifnewcust"
                                                    style="display:none;color:red;font-size: 10px;">*Nama Customer baru,
                                                    inputkan pada keterangan !</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-info btn-flat modalbarang" type="button"
                                                        id="btmodalbarang"><i class="bi bi-search"></i></button>
                                                </span>
                                            </div><!-- /input-group -->
                                            <div class="invalid-feedback" id="kobarRequired" style="display:none;color:red">
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table id="detail" class="display nowrap compact" cellspacing="0"
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <th colspan="5" style="text-align:right">Total (Rp.):
                                                                </th>
                                                                <th class="total"></th>
                                                            </tr>
                                                        </tfoot>
...
@section('page-script')
        ...
        $(function() {
            $("#chkcus").click(function() {
                if ($(this).is(":checked")) {
                    $("#dvcus").hide();
                    // $("#dvcusum").show(); 
                    $('#tipecust').val('UMUM MANDIRI');
                    $('#chkcus').val('1');
                    $('#notifnewcust').show();
                } else {
                    $("#dvcus").show();
                    // $("#dvcusum").hide();
                    $('#tipecust').val('MEMBER MANDIRI');
                    $('#chkcus').val('0');
                    $('#notifnewcust').hide();
                }
            });
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function invoice() {
                $.ajax({
                    url: "{{ route('codeinvoice_cust') }}",
                    method: "POST",
                    dataType: 'json',
                    success: function(result) {
                        $("#nota").val(result.invoice);
                    }
                });
