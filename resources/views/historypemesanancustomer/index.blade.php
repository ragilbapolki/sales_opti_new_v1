                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info alert-dismissible">
                                ...
                                * Data Pemesanan adalah tabel untuk melihat perubahan status "Deal/Cancel"
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#historipesan').DataTable({
                ...
                ajax: '{{ route('data_historypesan_cust') }}',
            ...
            function texport(dateawal = '', dateakhir = '') {
                ...
                var texport = $('#export').DataTable({
                    ...
                    ajax: {
                        url: '{{ route('export_historypesan_cust') }}',
                        method: 'GET',
                        data: {
                            dateawal: dateawal,
                            dateakhir: dateakhir
