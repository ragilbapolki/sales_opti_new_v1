                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tgl" class="form-control pull-right"
                                        value="{{ date('Y/m/d') }}" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask
                                        id="Date" />
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <a class="btn btn-warning btn-flat" id="generate" name="generate" type="button"><i
                                                class="fa fa-key"></i> Generate</a>
                                    </span>
                                </div><!-- /input-group -->
                                <span style="color:red;font-size: 10px;">* Silahkan generate invoice dahulu untuk
                            ...
                            @foreach ($datacustomers as $response)
                                <div class="form-group" id="dvcus">
                                    <label>Nama Customer</label>
                                    <input type="text" class="form-control" name="customerid" id="customerid"
                                        value="{{ $response->name }}" readonly />
                                    <input type="hidden" class="form-control" name="namacustmember" id="namacustmember"
                                        value="{{ $response->customer_id }}" readonly />
                        ...
                        <div class="box-body">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-info btn-flat modalbarang" type="button"
                                            id="btmodalbarang"><i class="fa fa-search"></i></button>
                                    </span>
                                </div><!-- /input-group -->
                                <div class="invalid-feedback" id="kobarRequired" style="display:none;color:red">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>Harga</label>
                                        <input type="text" class="form-control" name="harga" id="s_harga"
                                            readonly />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Diskon(%)</label>
                                        <input type="number" class="form-control" name="diskon" id="s_diskon"
                                            value="0" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div>
                                        <div class="form-group">
                                            <a class="btn btn-sm btn-danger" id="deleterow"><i class="fa fa-trash"></i>
                                                Delete</a>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group">
                                            <a class="btn btn-success modalbayar" id="btbayar" style="display: none"><i
                                                    class="fa fa-money"></i> Pembayaran</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
