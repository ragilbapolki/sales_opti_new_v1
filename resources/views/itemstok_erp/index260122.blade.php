			...
			if (isvalidate) {
				...
				$.ajax({
					...
					success: function(data) {
						...
						document.getElementById("header_hargappn").innerHTML = parseInt(data.item['hrgppn']);
						// console.log(data);
						...
						var table = $('#databarang').DataTable({
							...
							data : data.data,
							columns: [
								{ data: 'kode', className: "text-center", width: '18px' },
								{ data: 'alias', width: '18px' },
								{ data: 'kota', width: '18px' },
								{ data: 'stok', className: "text-center", width: '200px' },
							]
						});
