...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="new/assets/img/favicon.png" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <img src="new/assets/img/logo.png" width="175px" height="40px" alt="">
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Sales Opti! 👋</h4>
                        {{-- <p class="mb-4">Please sign-in to your account and start the adventure</p> --}}

                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            {{ csrf_field() }}
                            <div
                                class="mb-3 form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
